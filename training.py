...
def load_datasets(input_directory,output_directory, preset_key):
	PRESETS_DICTIONARY = {'PAN19_English': {'dataset_name': 'PAN 2019 English',
											'xmls_subdirectory': 'en/',
											'xmls_test': 'en/',
											},
						  }
	train_subpath=str(output_directory)+"/truth.txt"
	test_subpath=str(output_directory)+"/truth-dev.txt"
	...
	truth_path_train = os.path.join(TRAINING_DATASET_MAIN_DIRECTORY, train_subpath)
	truth_path_test = os.path.join(TRAINING_DATASET_MAIN_DIRECTORY, test_subpath)
...
def main_evaluation():
	...
	docs_train, docs_test, y_train, author_ids_test =load_datasets(input_directory,output_directory, preset_key)
...
#/media/training-datasets/author-profiling/pan19-author-profiling-training-dataset-2019-02-18
